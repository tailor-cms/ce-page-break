...
Authoring component for the **Section Break** content element in [Tailor CMS](https://github.com/tailor-cms/author).
...
```sh
npm install @tailor-cms/ce-page-break-edit
```
...
```ts
import { Edit } from '@tailor-cms/ce-page-break-edit';
```
